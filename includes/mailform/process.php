...
<body>
  ...
  <table id="parentframe" width="75%">
    ...
    <tbody>
      <tr>
        <td><h3>Dog and Rooster - Customer Information</h3></td>
      </tr>
        ...
        <td>
          ...
          <table id="childframe" width="100%">
            ...
            <tr>
              ...
              <td class="label-inputs">'.$interest.'</td>
            </tr>
            <tr>
              <td class="label">Timeframe</td>
              <td class="label-inputs">'.$timeframe.'</td>
            </tr>
            <tr>
...
$mail->AddAddress('webmail@localhost'); 

$mail->IsHTML(true); // send as HTML

$mail->Subject  =  'Keep in Touch with Dog and Rooster, Inc.';
$mail->Body     =  $message;
